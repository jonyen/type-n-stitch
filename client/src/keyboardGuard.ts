 ...
 * menu/listbox/popper already owns it (its own Space/Escape/arrow handling
 * would otherwise double-fire on the editor underneath), or something upstream
 * already called `preventDefault()` on it.
 */
